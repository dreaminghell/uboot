cmd_u-boot.lds := /media/rk3399/firefly-rk3399/u-boot/../prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android-gcc -E -Wp,-MD,./.u-boot.lds.d -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x00200000   -D__ARM__           -march=armv8-a  -fno-pic  -mgeneral-regs-only  -mstrict-align  -ffunction-sections -fdata-sections -fno-common -ffixed-r9   -fno-common -ffixed-x18 -pipe -Iinclude  -I/media/rk3399/firefly-rk3399/u-boot/arch/arm/include -include /media/rk3399/firefly-rk3399/u-boot/include/linux/kconfig.h  -nostdinc -isystem /media/rk3399/firefly-rk3399/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/../lib/gcc/aarch64-linux-android/4.9/include -include /media/rk3399/firefly-rk3399/u-boot/include/u-boot/u-boot.lds.h -DCPUDIR=arch/arm/cpu/armv8  -ansi -D__ASSEMBLY__ -x assembler-with-cpp -P -o u-boot.lds /media/rk3399/firefly-rk3399/u-boot/arch/arm/cpu/armv8/u-boot.lds

source_u-boot.lds := /media/rk3399/firefly-rk3399/u-boot/arch/arm/cpu/armv8/u-boot.lds

deps_u-boot.lds := \
    $(wildcard include/config/rockchip.h) \
  /media/rk3399/firefly-rk3399/u-boot/include/u-boot/u-boot.lds.h \
  include/config.h \
