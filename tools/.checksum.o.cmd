cmd_tools/checksum.o := cc -Wp,-MD,tools/.checksum.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer   -include /media/rk3399/firefly-rk3399/u-boot/include/libfdt_env.h -idirafterinclude -idirafter/media/rk3399/firefly-rk3399/u-boot/arch/arm/include -I/media/rk3399/firefly-rk3399/u-boot/lib/libfdt -I/media/rk3399/firefly-rk3399/u-boot/tools -DCONFIG_SYS_TEXT_BASE=0x00200000 -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE  -c -o tools/checksum.o tools/checksum.c
